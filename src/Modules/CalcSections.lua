...
return {
	{ 3, "HitDamage", 1, colorCodes.OFFENCE, { {
		...
		data = {
			...
			-- Skill Hit Damage
			generateTableByValues(
				{ label = "Total Increased", { format = "{0:mod:1}%", { modName = "Damage", modType = "INC", cfg = "skill" }, }, },
				DamageTypes, function (_, damageType)
					return { format = "{0:mod:1}%", { modName = damageType .. "Damage", modType = "INC", cfg = "skill" }, }
				end),
			generateTableByValues(
				{ label = "Total More", { format = "{0:mod:1}%", { modName = "Damage", modType = "MORE", cfg = "skill" }, }, },
				DamageTypes, function (_, damageType)
			...
			generateTableByValues(
				...
				DamageTypes, function (_, damageType)
					return {
						format = "x {3:output:" .. damageType .. "EffMult}",
			...
			generateTableByValues(
				...
				DamageTypes, function (_, damageType)
					return { format = "{1:output:" .. damageType .. "Damage}", { breakdown = damageType }, }
				end),
			{ label = "Skill Average Hit", { format = "{1:output:AverageHit}", { breakdown = "AverageHit" }, }, },
			{
				label = "Skill PvP Average Hit",
				flag = "notAttackPvP",
				{
					format = "{1:output:PvpAverageHit}",
			...
			{
				label = "Average Damage",
				haveOutput = "ExplodeChance",
				{ format = "{1:output:AverageDamage}", { breakdown = "AverageDamage" }, },
			},
			{
				label = "PvP Average Dmg",
				flag = "attackPvP",
				{
					format = "{1:output:PvpAverageDamage}",
	...
	{ 1, "Crit", 1, colorCodes.OFFENCE, { {
		...
		data = {
			...
			},
			{
				...
				{
					format = "x {2:output:CritMultiplier}",
	...
	{ 1, "SkillTypeStats", 1, colorCodes.OFFENCE, { {
		defaultCollapsed = false,
		label = "Skill type-specific Stats",
		data = {
			...
			{ label = "Active Minion Limit", haveOutput = "ActiveMinionLimit", { format = "{0:output:ActiveMinionLimit}" } },
			{
				...
				haveOutput = "QuantityMultiplier",
				{
					format = "{0:output:QuantityMultiplier}",
			...
			},
			{
				...
				haveOutput = "Cooldown",
				{ format = "{3:output:Cooldown}s", { breakdown = "Cooldown" }, { modName = "CooldownRecovery", cfg = "skill" }, },
			},
			{
				label = "Stored Uses",
				haveOutput = "StoredUses",
				{ format = "{output:StoredUses}", { breakdown = "StoredUses" }, { modName = "AdditionalCooldownUses", cfg = "skill" }, },
			},
			{
				label = "Duration Mod",
				flag = "duration",
				{
					format = "x {4:output:DurationMod}",
			...
			{
				label = "Split Count",
				haveOutput = "SplitCountString",
				{
					format = "{output:SplitCountString}",
			...
			},
			{
				...
				flag = "projectile",
				{
					format = "x {2:output:ProjectileSpeedMod}",
			...
			{ label = "Bounces Count", flag = "bounce", { format = "{output:BounceCount}", { modName = { "BounceCount", "ProjectileCount" }, cfg = "skill" }, }, },
			{
				...
				haveOutput = "AuraEffectMod",
				{
					format = "x {2:output:AuraEffectMod}",
			...
			},
			{
				...
				haveOutput = "CurseEffectMod",
				{ format = "x {2:output:CurseEffectMod}", { breakdown = "CurseEffectMod" }, { modName = "CurseEffect", cfg = "skill" }, },
			},
			{
				label = "Area of Effect Mod",
				haveOutput = "AreaOfEffectMod",
				{
					format = "x {2:output:AreaOfEffectMod}",
			...
			{
				label = "Trap Cooldown",
				haveOutput = "TrapCooldown",
				{ format = "{3:output:TrapCooldown}s", { breakdown = "TrapCooldown" }, { modName = "CooldownRecovery", cfg = "skill" }, },
			},
			...
			{
				label = "Trap Trigg. Radius",
				flag = "trap",
				{
					format = "{1:output:TrapTriggerRadiusMetre}m",
			...
			{
				label = "Trap Throw Rate",
				flag = "trap",
				{
					format = "{2:output:TrapThrowingSpeed}",
			...
			{
				label = "Totem Place Time",
				flag = "totem",
				notFlag = "triggered",
				{
					format = "{2:output:TotemPlacementTime}s",
					{ breakdown = "TotemPlacementTime" },
					{ modName = "TotemPlacementSpeed", cfg = "skill" },
				},
			},
			{
				label = "Active Totem Limit",
				flag = "totem",
				notFlag = "triggered",
				{
					format = "{0:output:ActiveTotemLimit}",
					{ breakdown = "ActiveTotemLimit" },
					{ modName = { "ActiveTotemLimit", "ActiveBallistaLimit" }, cfg = "skill" },
				},
			},
			{
				label = "Totem Duration Mod",
				flagList = { "duration", "totem" },
				{
					format = "x {4:output:TotemDurationMod}",
					{ breakdown = "TotemDurationMod" },
					{ modName = { "Duration", "PrimaryDuration", "TotemDuration" }, cfg = "skill" },
				},
			},
			{
				label = "Totem Duration",
				flagList = { "duration", "totem" },
				{ format = "x {4:output:TotemDuration}", { breakdown = "TotemDuration" }, },
			},
			{
				label = "Totem Life Mod",
				flag = "totem",
				notFlag = "triggered",
				{ format = "x {2:output:TotemLifeMod}", { breakdown = "TotemLifeMod" }, { modName = "TotemLife", cfg = "skill" }, },
			},
			{ label = "Totem Life", flag = "totem", notFlag = "triggered", { format = "{0:output:TotemLife}", { breakdown = "TotemLife" }, }, },
			{
				label = "Totem Block Chance",
				haveOutput = "TotemBlockChance",
				{
					format = "{0:output:TotemBlockChance}%",
			...
			{
				label = "Totem Armour",
				haveOutput = "TotemArmour",
				{ format = "{0:output:TotemArmour}", { breakdown = "TotemArmour" }, { modName = "TotemArmour", cfg = "skill" }, },
			},
	...
	{ 1, "LeechGain", 1, colorCodes.OFFENCE, { {
		defaultCollapsed = false,
		label = "Leech & Gain on Hit",
		data = {
			{
				label = "Life Leech Cap",
				flag = "leechLife",
				{ format = "{1:output:MaxLifeLeechRate}", { breakdown = "MaxLifeLeechRate" }, { modName = "MaxLifeLeechRate" }, },
			},
			{
				label = "Life Leech Rate",
				flag = "leechLife",
				notFlag = "showAverage",
				{
					format = "{1:output:LifeLeechRate}",
					{ breakdown = "LifeLeech" },
			...
			{
				label = "Life Leech per Hit",
				flagList = { "leechLife", "showAverage" },
				{
					format = "{1:output:LifeLeechPerHit}",
					{ breakdown = "LifeLeech" },
					{ label = "Player modifiers", notFlagList = { "totem", "attack" }, modName = { "DamageLeech", "DamageLifeLeech", "PhysicalDamageLifeLeech", "LightningDamageLifeLeech", "ColdDamageLifeLeech", "FireDamageLifeLeech", "ChaosDamageLifeLeech", "ElementalDamageLifeLeech" }, modType = "BASE", cfg = "skill" },
					{ label = "Main Hand", notFlag = "totem", flag = "weapon1Attack", modName = { "DamageLeech", "DamageLifeLeech", "PhysicalDamageLifeLeech", "LightningDamageLifeLeech", "ColdDamageLifeLeech", "FireDamageLifeLeech", "ChaosDamageLifeLeech", "ElementalDamageLifeLeech" }, modType = "BASE", cfg = "weapon1" },
					{ label = "Off Hand", notFlag = "totem", flag = "weapon2Attack", modName = { "DamageLeech", "DamageLifeLeech", "PhysicalDamageLifeLeech", "LightningDamageLifeLeech", "ColdDamageLifeLeech", "FireDamageLifeLeech", "ChaosDamageLifeLeech", "ElementalDamageLifeLeech" }, modType = "BASE", cfg = "weapon2" },
			...
			{
				label = "Life Gain Rate",
				notFlag = "showAverage",
				haveOutput = "LifeOnHitRate",
				{
					format = "{1:output:LifeOnHitRate}",
			...
			{
				label = "Life Gain per Hit",
				flag = "showAverage",
				haveOutput = "LifeOnHit",
				{
					format = "{1:output:LifeOnHit}",
					{ label = "Player modifiers", notFlag = "attack", modName = "LifeOnHit", modType = "BASE", cfg = "skill" },
					{ label = "Main Hand", flag = "weapon1Attack", modName = "LifeOnHit", modType = "BASE", cfg = "weapon1" },
					{ label = "Off Hand", flag = "weapon2Attack", modName = "LifeOnHit", modType = "BASE", cfg = "weapon2" },
					{ label = "Enemy modifiers", modName = { "SelfLifeOnHit" }, modType = "BASE", cfg = "skill", enemy = true },
			...
			{
				label = "Life Gain on Kill",
				haveOutput = "LifeOnKill",
				{ format = "{1:output:LifeOnKill}", { modName = "LifeOnKill" }, },
			},
			{
				label = "Mana Leech Cap",
				flag = "leechMana",
				{ format = "{1:output:MaxManaLeechRate}", { breakdown = "MaxManaLeechRate" }, { modName = "MaxManaLeechRate" }, },
			},
			{
				label = "Mana Leech Rate",
				flag = "leechMana",
				notFlag = "showAverage",
				{
					format = "{1:output:ManaLeechRate}",
					{ breakdown = "ManaLeech" },
			...
			{
				label = "Mana Leech per Hit",
				flagList = { "leechMana", "showAverage" },
				{
					format = "{1:output:ManaLeechPerHit}",
					{ breakdown = "ManaLeech" },
					{ label = "Player modifiers", notFlag = "attack", modName = { "DamageLeech", "DamageManaLeech", "PhysicalDamageManaLeech", "LightningDamageManaLeech", "ColdDamageManaLeech", "FireDamageManaLeech", "ChaosDamageManaLeech", "ElementalDamageManaLeech" }, modType = "BASE", cfg = "skill" },
					{ label = "Main Hand", flag = "weapon1Attack", modName = { "DamageLeech", "DamageManaLeech", "PhysicalDamageManaLeech", "LightningDamageManaLeech", "ColdDamageManaLeech", "FireDamageManaLeech", "ChaosDamageManaLeech", "ElementalDamageManaLeech" }, modType = "BASE", cfg = "weapon1" },
					{ label = "Off Hand", flag = "weapon2Attack", modName = { "DamageLeech", "DamageManaLeech", "PhysicalDamageManaLeech", "LightningDamageManaLeech", "ColdDamageManaLeech", "FireDamageManaLeech", "ChaosDamageManaLeech", "ElementalDamageManaLeech" }, modType = "BASE", cfg = "weapon2" },
			...
			{
				label = "Mana Gain Rate",
				notFlag = "showAverage",
				haveOutput = "ManaOnHitRate",
				{
					format = "{1:output:ManaOnHitRate}",
			...
			{
				label = "Mana Gain per Hit",
				flag = "showAverage",
				haveOutput = "ManaOnHit",
				{
					format = "{1:output:ManaOnHit}",
					{ label = "Player modifiers", notFlag = "attack", modName = "ManaOnHit", modType = "BASE", cfg = "skill" },
					{ label = "Main Hand", flag = "weapon1Attack", modName = "ManaOnHit", modType = "BASE", cfg = "weapon1" },
					{ label = "Off Hand", flag = "weapon2Attack", modName = "ManaOnHit", modType = "BASE", cfg = "weapon2" },
					{ label = "Enemy modifiers", modName = { "SelfManaOnHit" }, modType = "BASE", cfg = "skill", enemy = true },
			...
			{
				label = "Mana Gain on Kill",
				haveOutput = "ManaOnKill",
				{ format = "{1:output:ManaOnKill}", { modName = "ManaOnKill" }, },
			},
		}
	}
	} },
	{ 1, "MiscEffects", 1, colorCodes.OFFENCE, { {
		...
		data = {
			{
				label = "Stun Avoidance",
				{ format = "{0:output:StunAvoidance}", { breakdown = "StunAvoidance" }, { modName = "StunAvoidance" }, },
			},
			{ label = "Stun Threshold", flag = "hit", notFlag = "attack", { format = "x {2:output:EnemyStunThresholdMod}", { modName = "EnemyStunThreshold", cfg = "skill" }, }, },
			{
				...
				notFlag = "attack",
				{
					format = "{2:output:EnemyStunDuration}s",
			...
			},
			{
				...
				haveOutput = "KnockbackChance",
				{
					format = "{0:output:KnockbackChance}%",
			...
			{
				label = "Knockback Dist.",
				haveOutput = "KnockbackChance",
				{
					format = "{0:output:KnockbackDistance}",
	...
	{ 1, "Life", 2, colorCodes.LIFE, { {
		...
		data = {
			...
			{ label = "Healing Eff.", { format = "{0:output:HealingEffectiveness}%", { modName = "HealingEffectiveness" }, }, },
			{
				label = "Recovery",
				{
					format = "{1:output:LifeRegenRecovery} ({1:output:LifeRegenPercent}%)",
	...
	{ 1, "Mana", 2, colorCodes.MANA, { {
		...
		data = {
			...
			{ label = "Total", { format = "{0:output:Mana}", { breakdown = "Mana" }, }, },
			{
				label = "Recovery",
				{
					format = "{1:output:ManaRegenRecovery} ({1:output:ManaRegenPercent}%)",
	...
	{ 1, "Resist", 3, colorCodes.DEFENCE, { {
		...
		data = generateTableByValues({},
			...
			DamageTypes, function (i, damageType)
				return {
					label = DamageTypesColored[i] .. " Resist",
					{
						format = "{0:output:" ..
							damageType .. "Resist}% (+{0:output:" .. damageType .. "ResistOverCap}%)",
	...
	{ 1, "Armour", 3, colorCodes.ARMOUR, { {
		...
		data = {
			...
			{
				label = "Phys. Dmg. Reduct",
				{
					format = "{0:output:PhysicalDamageReduction}%",
	...
	{ 1, "DamageAvoidance", 3, colorCodes.DEFENCE, { {
		defaultCollapsed = false,
		label = "Block",
		data = {
			extra = "{0:output:BlockChance}%/{0:output:SpellBlockChance}%",
			{
				label = "Block Chance",
				{
					format = "{0:output:BlockChance}% (+{0:output:BlockChanceOverCap}%)",
			...
			},
			{
				...
				{ format = "{0:output:BlockEffectiveness}", { breakdown = "BlockEffectiveness" }, { modName = "BlockEffectiveness" }, },
			},
			{
				label = "Taken From Block",
				haveOutput = "ShowBlockEffect",
				{ format = "{0:output:DamageTakenOnBlock}%", { breakdown = "BlockEffect" }, { modName = { "BlockEffect" }, }, },
			},
		...
		data = {
			{ label = "Dodge Rating", { format = "{0:output:Evasion}", { modName = "Evasion" }, }, },
			{
				label = "Dodge Chance",
				{
					format = "{0:output:AttackDodgeChance}% (+{0:output:AttackDodgeChanceOverCap}%)",
	...
	-- misc others
	{ 1, "MiscOthers", 3, colorCodes.DEFENCE, { {
		defaultCollapsed = false,
		label = "Others",
		data = generateTableByValues({ label = "Skill Levels" },
			data.treeSkills, function (_, skillId)
				return {
					label = data.skills[skillId].name .. " Level",
					haveOutput = skillId .. "Level",
					{ format = "{0:output:" .. skillId .. "Level}", { breakdown = skillId .. "Level" }, { modName = skillId .. "Level" } }
				}
			end
		),
	},
	...
	-- damage taken
	{ 3, "DamageTaken", 1, colorCodes.DEFENCE, { {
		defaultCollapsed = false,
		label = "Damage Taken",
		data = {
			colWidth = 95,
			...
			generateTableByValues(
				...
				DamageTypes, function (_, damageType)
					return {
						format = "{2:output:" .. damageType .. "EnemyDamage}",
			...
			generateTableByValues(
				{ label = "Taken As", { format = "{2:output:totalTakenDamage}",
					{ breakdown = "totalTakenDamage" },
				} },
				DamageTypes, function (_, damageType)
					return { format = "{2:output:" .. damageType .. "TakenDamage}", { breakdown = damageType .. "TakenDamage" }, }
				end
			),
		}
	}, {
		...
		data = {
			...
			generateTableByValues(
				{ label = "Hit taken", { format = "{2:output:totalTakenHit}",
					{ breakdown = "totalTakenHit" },
				} },
				DamageTypes, function (_, damageType)
					return { format = "{2:output:" .. damageType .. "TakenHit}", { breakdown = damageType .. "TakenHit" }, }
				end
			),
		...
		data = {
			extra = "{0:output:TotalEHP}",
			{
				label = "Unmitigated %",
				{
					format = "{0:output:ConfiguredDamageChance}%",
			...
			{
				label = "Enemy miss chance",
				{
					format = "{0:output:ConfiguredNotHitChance}%",
			...
			{
				label = "Time before death",
				{
					format = "{2:output:EHPsurvivalTime}s",
		...
		data = {
			...
			generateTableByValues({ label = "Maximum Hit Taken" },
				DamageTypes, function (_, damageType)
					return { format = "{0:output:" .. damageType .. "MaximumHitTaken}", { breakdown = damageType .. "MaximumHitTaken" }, }
				end
			)
		}
	}, {
		defaultCollapsed = false,
		label = "Dots and Degens",
		data = {
			colWidth = 108,
			generateTableByValues({},
				DamageTypesColored, function (_, damageType)
			...
			generateTableByValues({ label = "DoT taken" },
				DamageTypes, function (_, damageType)
					return {
						format = "x {2:output:" .. damageType .. "TakenDotMult}",
			...
			generateTableByValues({ label = "Total Pool" },
				DamageTypes, function (_, damageType)
					return { format = "{0:output:" .. damageType .. "TotalPool}", { breakdown = damageType .. "TotalPool" }, }
				end
			),
			generateTableByValues({ label = "Effective DoT Pool" },
				DamageTypes, function (_, damageType)
					return { format = "{0:output:" .. damageType .. "DotEHP}", { breakdown = damageType .. "DotEHP" }, }
				end
			),
			generateTableByValues({ label = "Degens", haveOutput = "TotalDegen" },
				DamageTypes, function (_, damageType)
					return {
						format = "{0:output:" .. damageType .. "Degen}",
			...
			),
			{
				...
				haveOutput = "TotalNetRegen",
				{ format = "{1:output:TotalNetRegen}", { breakdown = "TotalNetRegen" }, },
			},
